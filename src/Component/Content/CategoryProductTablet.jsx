    ...
    showProduct = () => {
        if (this.state.dataProduct !== null) {
            ...
            return product.map((value, key) => {
                if (
                    (stringtoslug(value.productCategory).indexOf('tablet') !== -1) ||
                    (value.productCategory.toUpperCase().indexOf('tablet') !== -1) ||
                    (value.productCategory.indexOf('tablet') !== -1) ||
                    (value.productCategory.toLowerCase().indexOf('tablet') !== -1)) {
                    if (countProduct++ < 8) {
                        return (
        ...
        return (
            <section className="products">
                <div className="container">
                    <h2 className="h2 upp align-center"> {t("tablet")}</h2>
                    ...
                    <div className="align-right align-center-xs">
                        <hr className="offset-sm" />
                        <NavLink to="/store/tablet"> <h5 className="upp">{t("see-more")}</h5> </NavLink>
                    </div>
                </div>
            </section>
