...
// };
class CategoryProductTvaudio extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataProduct: null,
    ...
    showProduct = () => {
        if (this.state.dataProduct !== null) {
            ...
            return product.map((value, key) => {
                ...
                if (
                    (stringtoslug(value.productCategory).indexOf('tvaudio') !== -1) ||
                    (value.productCategory.toUpperCase().indexOf('tvaudio') !== -1) ||
                    (value.productCategory.indexOf('tvaudio') !== -1) ||
                    (value.productCategory.toLowerCase().indexOf('tvaudio') !== -1)) {
                    if (countProduct++ < 8) {
                        return (
        ...
        return (
            <section className="products">
                <div className="container">
                    <h2 className="h2 upp align-center"> {t("tv&audio")}</h2>
                    ...
                    <div className="align-right align-center-xs">
                        <hr className="offset-sm" />
                        <NavLink to="/store/tvaudio"> <h5 className="upp">{t("see-more")} </h5> </NavLink>
                    </div>
                </div>
            </section>
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryProductTvaudio)
