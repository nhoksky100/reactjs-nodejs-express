...
class CategoryProductSmartphone extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataProduct: null,
    ...
    isShow = () => {
        ...
        if (this.state.dataProduct !== null) {
            ...
            return product.map((value, key) => {
                if (
                    (stringtoslug(value.productCategory).indexOf('smartphone') !== -1) ||
                    (value.productCategory.toUpperCase().indexOf('smartphone') !== -1) ||
                    (value.productCategory.indexOf('smartphone') !== -1) ||
                    (value.productCategory.toLowerCase().indexOf('smartphone') !== -1)) {
                    if (countProduct++ < 8) {
                        return (
            ...
            <div>
                ...
                <section className="products">
                    <div className="container">
                        <h2 className="h2 upp align-center">{t("smartphone")}</h2>
                        <hr className="offset-lg" />
                        <div className="row">
                            {this.isShow()}
                        </div>
                        <div className="align-right align-center-xs">
                            <hr className="offset-sm" />
                            <NavLink to="/store/smartphone"> <h5 className="upp">{t("see-more")} </h5> </NavLink>
                        </div>
                    </div>
                </section>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryProductSmartphone)
