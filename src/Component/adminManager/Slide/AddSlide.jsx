...
class AddSlide extends Component {
    ...
    addSlide = () => {
        ...
        if (statusForm) {
            ...
            if
                ...
                var { slideImage, checkedCategory, title, statusForm } = this.state;
                axios.post('/add_slide', { id, slideImage, checkedCategory, title }).then(res => {
            ...
            if (slideImage !== '' && slideImage !== undefined && checkedCategory !== '' && title !== '') {
                var { slideImage, checkedCategory, title } = this.state;
                axios.post('/add_slide', { id, slideImage, checkedCategory, title }).then(res => {
                    toast(<div className="advertise"><i className="fa fa-minus-circle" aria-hidden="true" />
            ...
            <div className='row' >
                <div className="formRow" >
                    ...
                    <div className="form-group slide_category">
                        ...
                        <input type="radio" defaultValue={'laptop'} onChange={(e) => this.isChange(e)}
                            ref='checkedCategory' className="" name="checkedCategory" id="laptop" placeholder="Laptop" />
                        <small id="helpId" className="form-text ">Laptop</small>
                    </div>
                    <div className="form-group slide_category">
                        <label htmlFor="smartphone"></label>
                        <input type="radio" defaultValue={'smartphone'} onChange={(e) => this.isChange(e)}
                            ref='checkedCategory' className="" name="checkedCategory" id="smartphone" placeholder="Smartphone" />
                        <small id="helpId" className="form-text ">Smartphone</small>
                    </div>
                    <div className="form-group slide_category">
                        <label htmlFor="tvaudio"></label>
                        <input type="radio" defaultValue={'tvaudio'} onChange={(e) => this.isChange(e)}
                            ref='checkedCategory' className="" name="checkedCategory" id="tvaudio" placeholder="TV&Audio" />
                        <small id="helpId" className="form-text ">TV&Audio</small>
                    </div>
                    <div className="form-group slide_category">
                        <label htmlFor="tablet"></label>
                        <input type="radio" defaultValue={'tablet'} onChange={(e) => this.isChange(e)}
                            ref='checkedCategory' className="" name="checkedCategory" id="tablet" placeholder="Tablet" />
                        <small id="helpId" className="form-text ">Tablet</small>
                    </div>
                    <div className="form-group slide_category">
                        <label htmlFor="smartwatch"></label>
                        <input type="radio" defaultValue={'smartwatch'} onChange={(e) => this.isChange(e)}
                            ref='checkedCategory' className="" name="checkedCategory" id="smartwatch" placeholder="Smartwatch" />
                        <small id="helpId" className="form-text ">Smartwatch</small>
                    </div>
                    <div className="form-group slide_category">
                        <label htmlFor="accessories"></label>
                        <input type="radio" defaultValue={'accessories'} onChange={(e) => this.isChange(e)}
                            ref='checkedCategory' className="" name="checkedCategory" id="accessories" placeholder="" />
            ...
            <Fragment>
                ...
                <div className="formRow">
                    ...
                    <div className="form-group div_inline">
                        ...
                        <input style={{ display: 'none' }} className="block form-control" type="file" onChange={(e) => this.getFile(e)} name="slideImage" id="imageUpload" accept="img/*" ref="file" placeholder="title" aria-describedby="noteedit" />
                        <div className="row images_list" id="images_list">
                            {this.state.slideImage !== '' &&
                                < img className="url_img_slide" src={this.state.slideImage} alt='' />
                            }
    ...
    showImageUrl = () => {
        var { slideImage} = this.state
       
        if (slideImage !== '') {

            return (
                <div className="row images_list">
                    < img  className="url_img_slide" src={slideImage} alt='' />
    ...
    showFormUrl = () => {
        return (
            <div className="tab_container">
                <div className="formRow ">
                    <label className="formLeft" htmlFor="">
                        URL:
                    ...
                    <div className="form-group div_inline">
                        <span>
                            <input onChange={(e) => { this.isChange(e) }}
                                value={this.state.slideImage}

                                name="slideImage" style={{ width: '700px' }} id="" type="text" />
    ...
    render() {
        ...
        if (this.state.slideStatus) {
            return <Redirect to="/admin/slide.html" />
        }
        return (
                            ...
                            <div className="widget">
                                <fieldset>
                                    ...
                                    <div className="formSubmit">
                                        ...
                                        <input onClick={() => this.addSlide()} type="button" value="Thêm mới" className="redB button" />
