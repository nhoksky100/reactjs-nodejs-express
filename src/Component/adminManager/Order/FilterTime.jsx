...
class FilterTime extends Component {
    ...
    setStartUpdateDate = (date) => {
        ...
        this.props.SearchDateTimeStart(date)
    ...
    setEndDate = (date) => {
        ...
        this.props.SearchDateTimeEnd(date)
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        SearchDateTimeStart: (act_search_datetime) => {
            dispatch({ type: 'search_datetime_start', act_search_datetime })
        },
        SearchDateTimeEnd: (act_search_datetime) => {
            dispatch({ type: 'search_datetime_end', act_search_datetime })
        }
    }
}
