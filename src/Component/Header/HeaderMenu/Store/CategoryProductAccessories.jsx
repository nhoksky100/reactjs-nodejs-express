...
class CategoryProductAccessories extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataProduct: null,
    ...
    fetchMoreData = () => {
        ...
        // var t =Math.round(data.length/items.length);
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryProductAccessories)
